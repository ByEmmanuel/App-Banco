...
public class ImporteYConcepto extends PaginaPrincipalDashboard implements MetodosUserDashBoard, MetodosRegistro {
    ...
    private Button botonTransferir(){
        ...
        botonTransferir.setOnAction(Event -> {
            ...
            String cuentaOrigen = controller2.getNumeroDeCelular();
            String cuentaDestino = nuevoDestinatario.getDatosTransferenciaDestino();
            boolean resultadoOperacion = operacionesDAO.transferirDOS(mainLayoutImporte,cuentaOrigen,cuentaDestino,cantidad,true);
            if (resultadoOperacion){
                System.out.println("Transferencia realizada con exito");
                super.actualizarPantallas();
            }else {
